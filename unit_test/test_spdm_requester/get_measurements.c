...
static uint16_t m_libspdm_opaque_data_size;
static uint8_t m_libspdm_opaque_data[LIBSPDM_MAX_MESSAGE_M1M2_BUFFER_SIZE];
    ...
    void **response, uint64_t timeout)
{
    ...
    case 0x27: {
        ...
        *opaque_element_table_header;
        ...
        m_libspdm_opaque_data_size = (m_libspdm_opaque_data_size + 3) & ~3;
        ...
        *(uint16_t *)ptr = m_libspdm_opaque_data_size;
        ptr += sizeof(uint16_t);
