...
void libspdm_test_requester_get_certificate_case30(void **state)
{
    ...
    assert_int_equal(cert_chain_size, LIBSPDM_MAX_CERT_CHAIN_SIZE);
    libspdm_zero_mem(expected_cert_chain, sizeof(expected_cert_chain));
    assert_memory_equal(cert_chain, expected_cert_chain, LIBSPDM_MAX_CERT_CHAIN_SIZE);
